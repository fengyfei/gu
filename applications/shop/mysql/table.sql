...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `unionid` VARCHAR(29)  UNIQUE DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `category` (
  ...
  `parentid` INT(32) UNSIGNED NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `ware` (
  ...
  `parentcategoryid` INT(16) NOT NULL,
